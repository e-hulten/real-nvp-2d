...
class CouplingLayer(nn.Module):
    ...
    def __init__(self, data_dim,mask_type):
        ...
        self.scale = ScaleTranslate(data_dim)
        self.translate = ScaleTranslate(data_dim)
...
class CouplingLayer_old(nn.Module):
...
class ScaleTranslate_old(nn.Module):
